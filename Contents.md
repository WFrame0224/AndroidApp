...
## 8. Service & BroadcastReceiver的学习
...
- **SimpleServer / SimpleClient** 简单介绍了Android使用**Socket**进行网络通信的工作机制，并分别给与了PC端的_Server_代码和Android的_Client_代码
...
- **EachrtsDemo2** 介绍了使用[Echarts-Java类库](http://git.oschina.net/free/ECharts)实现的折线图的示例代码，比较方便的利用Java直接构建折线图具体参考[本人博客]

* * *

## 10. 蓝牙SPP协议的使用
### 26. BluetoothSpp
- **BluetoothSpp** 给出了采用[MacroYau](https://github.com/MacroYau)的开源项目[Blue2Serial](https://github.com/MacroYau/Blue2Serial)，直接适配运行而来
